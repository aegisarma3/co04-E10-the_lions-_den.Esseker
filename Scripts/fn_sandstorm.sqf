...
_result = if (_newspapers) then {
	_newsParams = [["images\gnews1.p3d", 1, 0, 1], "", "SpaceObject", 1, 5, [0, 0, 1], _velocity, 1, 1.25, 1, 0.2, [0,1,1,1,0], [[1,1,1,1]], [0.7], 1, 0, "", "", _obj];
	...
	_newsParams set [0,["images\gnews2.p3d", 1, 0, 1]];
	...
	_newsParams set [0,["images\gnews3.p3d", 1, 0, 1]];
